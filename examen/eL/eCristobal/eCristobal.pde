/* Cristóbal Schaerer
 ...
 El azul indica que esos días hubo lluvia, el rojo indica la presencia de neblina y por último el
...
void draw() {
  ...
  if (years == true) {
    if (n<=80 || n >356) {
      ...
      text("Verano", (width/2)-100, 670); 
      textSize(30);
    } else if (n>80 && n <=173 ) {
      background(255, 153, 0); 
      text("Otoño", (width/2)-100, 670); 
      textSize(30);
    } else if (n >173 && n<=267) {
      background(0, 180, 255);
      text("Invierno", (width/2)-100, 670); 
      textSize(30);
    } else if (n > 267 && n<= 356) {
