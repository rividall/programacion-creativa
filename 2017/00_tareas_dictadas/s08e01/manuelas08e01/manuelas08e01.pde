...
void draw() {
  if (b) { 
    ...
    donut(450, 150, colores[0], colores[1], colores[3], colores[2], 50); 
    circulo(150, 150, 100, colores[0], colores[1], colores[3], colores[2], 10, 3); 
    argollas(750, 150, 200, colores[0], colores[1], colores[3], colores[2], 10);
  } 
  if (!b) { 
    background(colores[2]); 
    donut(450, 150, colores[1], colores[0], colores[2], colores[3], 20); 
    circulo(750, 150, 50, colores[1], colores[0], colores[2], colores[3], 5, 6); 
    argollas(150, 150, 200, colores[1], colores[0], colores[2], colores[3], 10);
  }
} 
