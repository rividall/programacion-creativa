...
//se utiliza j,k, barra espacio )
//
// con función de interruptor, al apretarla una vez inicia una función y al volver a apretarlas estas desaparecen, funcionando
//
// en base a una condición especifica que es que las otras funciones esten desactivadas, por lo que no se podran ver las tres funcionando
//
// simultáneamente.
//
